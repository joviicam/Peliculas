<template>
    <div class="peliculas-container">
        ...
        <b-button v-b-modal.modal-create>Registrar película</b-button>
        <div class="row">
        ...
        <b-modal id="modal-create" ref="modal-create" title="Crear película" @show="resetModal" @hidden="resetModal"
            @ok="createMovie">
            <form ref="form" @submit.stop.prevent="handleSubmit">
                <b-form-group label="Name" label-for="name-input" invalid-feedback="Name is required"
